...
void initializeWindow()
{
  ...
  // Create window, set title and get graphics context
  // make is visible and ready
...
// Redraw  city areas and taxis that are on route.
// Runs in an infinite loop continuously drawing the city.
